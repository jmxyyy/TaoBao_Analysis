package taobao.step03;

import taobao.step03.mapper.DateStatMapper;
import taobao.step03.reducer.DateStatReducer;
...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        Job job = Job.getInstance(conf, "STEP03");
        ...
        job.setMapperClass(DateStatMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(Text.class);
        job.setReducerClass(DateStatReducer.class);
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(NullWritable.class);
        job.setOutputFormatClass(TextOutputFormat.class);
        Path out = new Path("/taobao_data_output/Step03");
        ...
        if (flag){
            System.out.println("Step03运⾏成功");
            return 0;
        }
        else{
            System.out.println("Step03运⾏失败");
            return 1;
        }
    }
}
